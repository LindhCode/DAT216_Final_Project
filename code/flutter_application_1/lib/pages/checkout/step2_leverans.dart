...
class Step2Leverans extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ConstrainedBox(
      ...
      child: Column(
        children: [
          const Text('2. Leverans', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold)),
          ...
          CheckoutCard(
            child: Column(
              ...
              children: [
                const Text('Vart ska vi leverera?', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
