...
class CheckoutStepIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      color: Colors.white,
      child: Center(
        child: SingleChildScrollView( // Försäkrar att den inte kraschar på små skärmar
                ...
                children: [
                  CustomPaint(
                    ...
                    painter: _ChevronPainter(
                      color: isDoneOrActive ? const Color(0xFF4C8C4A) : const Color(0xFFE0E0E0),
                      isFirst: index == 0,
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 13,
                      fontWeight: index == currentStep ? FontWeight.bold : FontWeight.w500,
